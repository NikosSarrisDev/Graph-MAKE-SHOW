...
//                Toast.makeText(this, "Not CSV Yet", Toast.LENGTH_SHORT).show();
                Intent intent_csv = new Intent(SCATTER_Chart_Activity.this, SCATTER_CSV_Chart.class);
...
//                barChart.saveToGallery(filename , 0);
                ...
                break;
            case 4:
                Intent intent = new Intent(SCATTER_Chart_Activity.this, Custom_scatter_Chart.class);
