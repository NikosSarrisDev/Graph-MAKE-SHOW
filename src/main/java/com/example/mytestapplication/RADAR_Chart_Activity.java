...
public class RADAR_Chart_Activity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new RadarEntry(100f));
        list.add(new RadarEntry(101f));
        list.add(new RadarEntry(102f));
        list.add(new RadarEntry(103f));
        list.add(new RadarEntry(104f));

        RadarDataSet radarDataSet = new RadarDataSet(list,"List");
...
//                System.out.println("Now it is saved");
                radarChart.saveToGallery(filename , foldername , "" , Bitmap.CompressFormat.JPEG , 0);
...
//                Toast.makeText(this, "Not CSV Yet", Toast.LENGTH_SHORT).show();
                Intent intent_csv = new Intent(RADAR_Chart_Activity.this, RADAR_CSV_Chart.class);
...
//                barChart.saveToGallery(filename , 0);
                ...
                break;
            case 4:
                Intent intent = new Intent(RADAR_Chart_Activity.this, Custom_radar_Chart.class);
