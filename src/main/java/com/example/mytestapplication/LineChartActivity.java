...
public class LineChartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Button for thickness of line
        Button submit_button_Thickness = (Button) findViewById(R.id.submit_button_for_thickness);
...
//            y = x + 1;
        ...
        //Listener for setDrawable to true or false
        setDrawCheckbox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
        ...
        //Listener for submiting the thickness of the line
        submit_button_Thickness.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                series.setThickness(editText_for_Thickness.getText().toString());
    ...
    public void openFullScreen_line_Activity() {
        Intent intent = new Intent(this, FullScreen_line_Activity.class);
