...
public class LINE_Chart_Activity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
...
//                System.out.println("Now it is saved");
                lineChart.saveToGallery(filename , foldername , "" , Bitmap.CompressFormat.JPEG , 0);
...
//                Toast.makeText(this, "Not CSV Yet", Toast.LENGTH_SHORT).show();
                Intent intent_csv = new Intent(LINE_Chart_Activity.this, LINE_CSV_Chart.class);
...
//                barChart.saveToGallery(filename , 0);
                ...
                break;
            case 4:
                Intent intent = new Intent(LINE_Chart_Activity.this, Custom_line_Chart.class);
